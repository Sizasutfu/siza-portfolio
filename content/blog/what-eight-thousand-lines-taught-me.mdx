...
The DM module took real care, because there was no one to catch it if I got the encryption wrong or the delete window let someone edit something they shouldn't. Message edit and delete have time-window constraints for exactly that reason.
