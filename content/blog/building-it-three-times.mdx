...
**Whispers** are anonymous messages, and they turned out to be the hardest thing to get right. Not because hiding the sender is hard, but because I had to decide what to record at all. The answer, eventually, was nothing that identifies them. I wrote a [separate post about that decision](/blog/theres-no-sender-to-hide), because it took longer to arrive at than the code did.
